...
export const eventList: Event[] = [
    ...
    { id: 7304, event: '你在废弃的祠堂里捡到一枚黯淡的玉简，上面有开灵口诀。', grade: 1, realm: 1, immortalEffect: { CULT: 12, SE: 6 } },
    ...
    { id: 7311, event: '你在河边看鱼，看了一整天，竟悟出了「观水」的开灵法门。', grade: 1, realm: 1, immortalEffect: { CULT: 13 } },
    ...
    { id: 7404, event: '你在古修士洞府里捡到一枚凝脉丹，如虎添翼。', grade: 2, realm: 2, immortalEffect: { CULT: 26, SE: 14 } },
    { id: 7405, event: '你与一只凝脉期的狸猫精结为道友，相约同闯仙途。', grade: 1, realm: 2, immortalEffect: { CULT: 20, SE: 10 } },
    ...
    { id: 7410, event: '你在凝脉中期闭关，出来时已小有所成。', grade: 0, realm: 2, immortalEffect: { CULT: 20, SE: 10 } },
    { id: 7411, event: '你与一位凝脉剑修切磋，输是输了，却学到了剑意。', grade: 1, realm: 2, immortalEffect: { CULT: 24 } },
    { id: 7412, event: '你在拍卖会上用一瓶猫薄荷，换到了一件残破的护身法宝。', grade: 2, realm: 2, immortalEffect: { CULT: 22, SE: 12 } },

    // 结丹
    { id: 7501, event: '你的结丹圆转如意，修为日益深厚。', grade: 1, realm: 3, immortalEffect: { CULT: 32, SE: 15 } },
    { id: 7502, event: '你在丹炉前枯坐七日，炼成一炉「猫猫护心丹」。', grade: 2, realm: 3, immortalEffect: { CULT: 38, SE: 18 } },
    { id: 7503, event: '你以结丹修为，斩了一头为祸的狼妖，威名远播。', grade: 2, realm: 3, effect: { STR: 2 }, immortalEffect: { CULT: 40 } },
    { id: 7504, event: '你在秘境中与一位结丹女修结伴，一路互相扶持。', grade: 1, realm: 3, immortalEffect: { CULT: 34, SE: 16 } },
    { id: 7505, event: '你炼化了一枚千年冰髓，心境愈发澄澈。', grade: 2, realm: 3, immortalEffect: { CULT: 42, SE: 20 } },
    { id: 7506, event: '你闭关一甲子，出关时结丹已然圆满。', grade: 1, realm: 3, effect: { AGE: 60 }, immortalEffect: { CULT: 75 } },
    { id: 7507, event: '你收了一只结丹期的鼠妖当探子，情报网遍布千里。', grade: 1, realm: 3, immortalEffect: { CULT: 35, SE: 15 } },
    { id: 7508, event: '你在雷雨夜引天雷炼体，结丹愈发璀璨。', grade: 1, realm: 3, effect: { STR: 1 }, immortalEffect: { CULT: 38, SE: 18 } },
    { id: 7509, event: '你与一条结丹期的蛟龙斗法，险胜半招。', grade: 2, realm: 3, effect: { STR: 2 }, immortalEffect: { CULT: 42 } },
    { id: 7510, event: '你在万兽谷讲道，群兽朝拜，你颇有几分宗师气度。', grade: 1, realm: 3, immortalEffect: { CULT: 36, SE: 16 } },
    { id: 7511, event: '你寻得一枚化形契机，只等水到渠成。', grade: 2, realm: 3, immortalEffect: { CULT: 45, SE: 20 } },
    { id: 7512, event: '你回望凡间，昔日的小镇已换了人间，你心头一颤。', grade: 1, realm: 3, immortalEffect: { CULT: 33 } },

    // 化形
    { id: 7601, event: '你的化形已是巴掌大的小猫，能与你心意相通。', grade: 1, realm: 4, immortalEffect: { CULT: 48, SE: 22 } },
    { id: 7602, event: '你妖婴出窍，遨游星海，见天地之浩瀚。', grade: 2, realm: 4, immortalEffect: { CULT: 55, SE: 25 } },
    { id: 7603, event: '你在星空古路闭关三百年，一朝顿悟。', grade: 2, realm: 4, effect: { AGE: 300 }, immortalEffect: { CULT: 140 } },
    { id: 7604, event: '你以化形修为，镇压了一头千年蛟龙，名震一方。', grade: 3, realm: 4, effect: { STR: 2 }, immortalEffect: { CULT: 75, SE: 30 } },
    { id: 7605, event: '你收下三百猫弟子，开宗立派，成了「猫祖」。', grade: 2, realm: 4, immortalEffect: { CULT: 55, SE: 25 } },
    { id: 7606, event: '你在仙府遗迹中寻得一卷通神诀，如获至宝。', grade: 3, realm: 4, immortalEffect: { CULT: 80, SE: 35 } },
    { id: 7607, event: '你与一位通神老怪论道，被骂醒，却受益终身。', grade: 2, realm: 4, immortalEffect: { CULT: 60, SE: 25 } },
    { id: 7608, event: '你在雷池中炼婴，化形愈发剔透，宛若琉璃。', grade: 2, realm: 4, effect: { STR: 2 }, immortalEffect: { CULT: 65, SE: 30 } },
    ...
    { id: 7612, event: '你的化形中期已成，离通神又近了一步。', grade: 0, realm: 4, immortalEffect: { CULT: 52, SE: 22 } },

    // 通神
    { id: 7701, event: '你通神之后，一道神识便可遍观三千里山河。', grade: 2, realm: 5, immortalEffect: { CULT: 70, SE: 32 } },
    ...
    { id: 7707, event: '你与一条通神期的真龙结拜，它唤你「猫兄」。', grade: 2, realm: 5, effect: { STR: 2 }, immortalEffect: { CULT: 90, SE: 40 } },
    ...
    { id: 7710, event: '你在通神巅峰盘坐，只待那最后一劫的降临。', grade: 1, realm: 5, effect: { AGE: 100 }, immortalEffect: { CULT: 92, SE: 40 } },
