...
export const eventList: Event[] = [
    ...
    { id: 6605, event: '你被一只开灵期的兔妖抢了胡萝卜，你追了它三里地。', grade: 0, realm: 1, effect: { STR: 1 }, immortalEffect: { CULT: 9 } },
    ...
    // 凝脉
    { id: 6701, event: '你在凝脉后第一次御气飞行，摔了个猫啃泥。', grade: 0, realm: 2, effect: { STR: -1 }, immortalEffect: { CULT: 16 } },
    { id: 6702, event: '你在山巅吸收日精月华，筑起了更坚实的道基。', grade: 1, realm: 2, immortalEffect: { CULT: 20, SE: 10 } },
    { id: 6703, event: '你与一只凝脉期的狐狸精斗智，略胜一筹。', grade: 1, realm: 2, effect: { INT: 1 }, immortalEffect: { CULT: 18 } },
    ...
    // 结丹
    { id: 6801, event: '你的结丹圆融饱满，修为精进得极快。', grade: 1, realm: 3, immortalEffect: { CULT: 32, SE: 15 } },
    { id: 6802, event: '你在丹会上一鸣惊人，被一位丹道宗师收为记名弟子。', grade: 2, realm: 3, immortalEffect: { CULT: 38, SE: 18 } },
    { id: 6803, event: '你以结丹修为，硬撼了一位化形老怪的威压，虽败犹荣。', grade: 2, realm: 3, effect: { STR: 1 }, immortalEffect: { CULT: 36 } },
    { id: 6804, event: '你在北海寻到一枚千年冰心，炼化后心境通明。', grade: 2, realm: 3, immortalEffect: { CULT: 40, SE: 20 } },
    { id: 6805, event: '你收了一只结丹期的老鼠精当军师，猫鼠联手，天下无敌。', grade: 1, realm: 3, immortalEffect: { CULT: 34, SE: 15 } },
    { id: 6806, event: '你在雷雨夜引雷炼体，结丹愈发光亮。', grade: 1, realm: 3, effect: { STR: 1 }, immortalEffect: { CULT: 35, SE: 18 } },
    { id: 6807, event: '你闭关五十年，出关时昔日的猫友已化作一抔黄土。', grade: 1, realm: 3, effect: { AGE: 50 }, immortalEffect: { CULT: 70 } },
    { id: 6808, event: '你在秘境中夺得一枚化形果，为突破化形埋下伏笔。', grade: 2, realm: 3, immortalEffect: { CULT: 45, SE: 20 } },
    { id: 6809, event: '你与一条结丹期的蛟龙斗法，斗了个旗鼓相当。', grade: 2, realm: 3, effect: { STR: 2 }, immortalEffect: { CULT: 40 } },
    { id: 6810, event: '你在万兽谷讲道，一讲就是三天，群兽听得如痴如醉。', grade: 1, realm: 3, immortalEffect: { CULT: 38, SE: 18 } },

    // 化形
    { id: 6901, event: '你的化形日渐凝实，已能离体游历。', grade: 1, realm: 4, immortalEffect: { CULT: 48, SE: 22 } },
    { id: 6902, event: '你在星空古路闭关三百年，妖婴出窍，遨游星海。', grade: 2, realm: 4, effect: { AGE: 300 }, immortalEffect: { CULT: 140 } },
    { id: 6903, event: '你与一位通神老怪论道，被骂了三天，却悟透了瓶颈。', grade: 2, realm: 4, immortalEffect: { CULT: 60, SE: 25 } },
    { id: 6904, event: '你在上古洞天里得到一株通神草，服下后气息暴涨。', grade: 3, realm: 4, immortalEffect: { CULT: 80, SE: 30 } },
    { id: 6905, event: '你的猫族后辈来朝拜你，你随手点化了三只小猫。', grade: 1, realm: 4, immortalEffect: { CULT: 50, SE: 22 } },
    { id: 6906, event: '你以化形修为，镇压了一头为祸的千年蛟龙。', grade: 3, realm: 4, effect: { STR: 2 }, immortalEffect: { CULT: 75, SE: 30 } },
    ...
    { id: 6909, event: '你在雷池中炼婴，化形愈发剔透。', grade: 2, realm: 4, effect: { STR: 2 }, immortalEffect: { CULT: 65, SE: 30 } },
    { id: 6910, event: '你寻得半部飞升诀，如获至宝。', grade: 3, realm: 4, immortalEffect: { CULT: 85, SE: 35 } },

    // 通神
    { id: 7101, event: '你通神后，一道神识可遍观三千里山河。', grade: 2, realm: 5, immortalEffect: { CULT: 70, SE: 32 } },
    ...
    { id: 7107, event: '你与一条通神期的真龙结拜，它唤你一声「猫兄」。', grade: 2, realm: 5, effect: { STR: 2 }, immortalEffect: { CULT: 90, SE: 40 } },
    { id: 7108, event: '你回望来路，从一只小奶猫到通神大能，恍如隔世。', grade: 1, realm: 5, immortalEffect: { CULT: 78 } },
    { id: 7109, event: '你炼化了一枚上古妖帝的妖核，妖力大涨。', grade: 3, realm: 5, immortalEffect: { CULT: 105, SE: 45 } },
    { id: 7110, event: '你在通神巅峰盘坐百年，只待那最后一劫。', grade: 1, realm: 5, effect: { AGE: 100 }, immortalEffect: { CULT: 92, SE: 40 } },
