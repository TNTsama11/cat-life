...
export const eventList: Event[] = [
    ...
    { id: 7905, event: '你在破庙里遇见一只开灵期的老鼠精，它哭着拜你为师。', grade: 1, realm: 1, immortalEffect: { CULT: 10, SE: 5 } },
    ...
    { id: 7909, event: '你与一只开灵期的鸟妖争抢一颗灵果，大打出手，最终平分。', grade: 1, realm: 1, immortalEffect: { CULT: 11 } },
    { id: 7910, event: '你在夜里吞吐灵气，惊动了屋主，他把你当成了「仙猫」。', grade: 1, realm: 1, immortalEffect: { CULT: 10, SE: 5 } },

    // 凝脉
    { id: 8001, event: '你在凝脉后第一次御风而行，吓得紧紧闭着眼。', grade: 0, realm: 2, immortalEffect: { CULT: 17 } },
    ...
    { id: 8005, event: '你在深山里采药，被一条凝脉期的蛇妖拦路，你绕道而行。', grade: 0, realm: 2, immortalEffect: { CULT: 16 } },
    ...
    { id: 8010, event: '你在凝脉中期闭关三月，出关时神清气爽。', grade: 0, realm: 2, immortalEffect: { CULT: 19, SE: 10 } },

    // 结丹
    { id: 8101, event: '你的结丹日益圆融，隐隐有突破化形的迹象。', grade: 1, realm: 3, immortalEffect: { CULT: 33, SE: 15 } },
    { id: 8102, event: '你在丹会上露了一手，被一位丹道宗师夸赞「有灵性」。', grade: 2, realm: 3, immortalEffect: { CULT: 38, SE: 18 } },
    { id: 8103, event: '你以结丹修为，镇压了一头祸害乡里的虎妖，乡民感恩戴德。', grade: 2, realm: 3, effect: { STR: 2 }, immortalEffect: { CULT: 40 } },
    { id: 8104, event: '你在秘境中与一位结丹女修并肩作战，暗生情愫。', grade: 1, realm: 3, immortalEffect: { CULT: 34, SE: 16 } },
    { id: 8105, event: '你炼化了一枚千年温玉，心境平和，修炼一日千里。', grade: 2, realm: 3, immortalEffect: { CULT: 42, SE: 20 } },
    { id: 8106, event: '你闭关一甲子，出关时结丹已然圆满，只待化形。', grade: 1, realm: 3, effect: { AGE: 60 }, immortalEffect: { CULT: 75 } },
    { id: 8107, event: '你收了只结丹期的鼠妖当情报头子，江湖消息尽在掌握。', grade: 1, realm: 3, immortalEffect: { CULT: 35, SE: 15 } },
    { id: 8108, event: '你在雷雨夜引雷炼体，结丹愈发光亮，肉身更强。', grade: 1, realm: 3, effect: { STR: 1 }, immortalEffect: { CULT: 38, SE: 18 } },
    { id: 8109, event: '你在万兽谷讲道，群兽听得如痴如醉，你颇有大宗师气度。', grade: 1, realm: 3, immortalEffect: { CULT: 36, SE: 16 } },
    { id: 8110, event: '你寻得一枚化形丹，为突破化形添了一分把握。', grade: 2, realm: 3, immortalEffect: { CULT: 45, SE: 20 } },

    // 化形
    { id: 8201, event: '你的化形已是半大的小猫，能与你一同参悟功法。', grade: 1, realm: 4, immortalEffect: { CULT: 48, SE: 22 } },
    { id: 8202, event: '你妖婴出窍，遨游星空，见宇宙之浩渺，心生敬畏。', grade: 2, realm: 4, immortalEffect: { CULT: 55, SE: 25 } },
    { id: 8203, event: '你在星空古路闭关三百年，一朝顿悟，修为大进。', grade: 2, realm: 4, effect: { AGE: 300 }, immortalEffect: { CULT: 140 } },
    { id: 8204, event: '你以化形修为，镇压了一头千年蛟龙，名震一方。', grade: 3, realm: 4, effect: { STR: 2 }, immortalEffect: { CULT: 75, SE: 30 } },
    { id: 8205, event: '你开宗立派，收了三百猫弟子，成了「猫祖」。', grade: 2, realm: 4, immortalEffect: { CULT: 55, SE: 25 } },
    { id: 8206, event: '你在仙府遗迹中寻得一卷通神诀，如获至宝。', grade: 3, realm: 4, immortalEffect: { CULT: 80, SE: 35 } },
    { id: 8207, event: '你与一位通神老怪论道，被骂醒，却受益终身。', grade: 2, realm: 4, immortalEffect: { CULT: 60, SE: 25 } },
    { id: 8208, event: '你在雷池中炼婴，化形愈发剔透，宛若琉璃。', grade: 2, realm: 4, effect: { STR: 2 }, immortalEffect: { CULT: 65, SE: 30 } },
    ...
    // 通神
    { id: 8301, event: '你通神之后，一道神识便可遍观三千里山河。', grade: 2, realm: 5, immortalEffect: { CULT: 70, SE: 32 } },
    ...
    { id: 8307, event: '你与一条通神期的真龙结拜，它唤你「猫兄」。', grade: 2, realm: 5, effect: { STR: 2 }, immortalEffect: { CULT: 90, SE: 40 } },
    ...
    { id: 8310, event: '你在通神巅峰盘坐，只待那最后一劫的降临。', grade: 1, realm: 5, effect: { AGE: 100 }, immortalEffect: { CULT: 92, SE: 40 } },
